...
**Plans**: 4 plans
Plans:
- [ ] 05-01-PLAN.md — 定义辅助页共享壳层与影响范围设计契约
- [ ] 05-02-PLAN.md — 扩展审计元数据契约与本地持久化迁移
- [ ] 05-03-PLAN.md — 打通富化审计写入并重构日志列表/详情页
- [ ] 05-04-PLAN.md — 统一模板与设置页结构并澄清本地影响边界
**UI hint**: yes
